...
def procesar_final(ruta_excel, datos_ui):
    ...
    if not datos_colegios: return None
    ...
    # Devolvemos un diccionario con el resumen real para la pantalla de éxito
    return {
        "actas": contador_exitos,
        "tiempo": round(fin_cronometro - inicio_cronometro, 2),
        "errores": errores
    }